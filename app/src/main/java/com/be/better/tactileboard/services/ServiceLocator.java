...
public class ServiceLocator {
    ...
    public static void bindInstance(@NonNull Class interfaceClass, @NonNull Object implementation){
        synchronized (sServicesInstancesLock){
            String name = interfaceClass.getName();
            sServicesImplementationsMapping.put(name, implementation.getClass());
            sServicesInstances.put(name, implementation);
        }
    }
